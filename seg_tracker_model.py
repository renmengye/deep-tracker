...
tfplus.cmd_args.add('st:base_learn_rate', 'float', 1e-4)
tfplus.cmd_args.add('st:learn_rate_decay', 'float', 1e-1)
tfplus.cmd_args.add('st:steps_per_learn_rate_decay', 'int', 10000)
