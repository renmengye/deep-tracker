...
def get_dataset(folder, opt, split='train', seqs=None):
    ...
    Args:
        ...
        split:
            ...
            valid: sequences 13 - 20

        seqs:
            list of sequences. if none,
    ...
    with sh.ShardedFileReader(dataset_file) as reader:
        for seq_num in seqs:
            ...
            output_labels = np.zeros([num_ex_neg + num_ex_pos])
...
if __name__ == '__main__':
    ...
    get_dataset('/ais/gobi3/u/mren/data/kitti/tracking/training', opt, 'train')
